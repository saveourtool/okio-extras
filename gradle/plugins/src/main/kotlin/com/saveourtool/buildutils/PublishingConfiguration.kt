    ...
    configure<PublishingExtension> {
        ...
        publications.withType<MavenPublication>().configureEach {
            ...
            this.pom {
                ...
                url.set("https://github.com/saveourtool/okio-extras")
                licenses {
                    license {
                        name.set("MIT License")
                        url.set("https://github.com/saveourtool/okio-extras/blob/main/LICENSE")
                ...
                developers {
                    developer {
                        ...
                        email.set("andrewbass@gmail.com")
                    }
                }
                scm {
                    url.set("https://github.com/saveourtool/okio-extras")
                    connection.set("scm:git:git://github.com/saveourtool/okio-extras.git")
                }
            }
        }
    }
    ...
    configure<NexusPublishExtension> {
        repositories {
            sonatype {
                ...
                packageGroup.set("com.saveourtool")
            }
        }
    }
}
